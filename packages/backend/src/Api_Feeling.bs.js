...
function add(payload, context) {
  var createdRecordId = context.db.ref("/feelings").push(payload, undefined).key;
  if (createdRecordId == null) {
    return $$Promise.resolved(undefined);
  }
  var r = context.db.ref("/feelings/" + createdRecordId);
...
function list(payload, context) {
  return Chain.onFinish(Chain.get(context.db, "/feelings"), (function (feelings) {
