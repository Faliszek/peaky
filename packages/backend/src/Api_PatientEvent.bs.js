...
function add(payload, context) {
  var createdRecordId = context.db.ref("/patient-events").push(payload, undefined).key;
  if (createdRecordId == null) {
    return $$Promise.resolved(undefined);
  }
  var r = context.db.ref("/patient-events/" + createdRecordId);
...
function list(payload, context) {
  return Chain.onFinish(Chain.get(context.db, "/patient-events"), (function (feelings) {
