...
@val external set: (unit => unit, int) => timeoutID = "setTimeout"

@val external clear: timeoutID => unit = "setTimeout"
...
@module("use-debounce")
external useDebounce: (array<point>, int) => array<array<point>> = "useDebounce"
