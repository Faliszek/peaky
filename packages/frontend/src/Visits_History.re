...
let make = (~calls: array(Call.t), ~callMode) => {
  <div className="shadow-md border border-gray-200 rounded-lg px-8">
    <div className="flex w-full">
      <Table.Th text={j|Numer ID|j} width="w-1/6" />
      <Table.Th text={j|Czas trwania|j} width="w-1/5" />
      <Table.Th text={j|Data rozpoczęcia|j} width="w-1/5" />
      <Table.Th text={j|Pacjent|j} width="w-1/5" />
      <Table.Th text={j|Szczegóły|j} width="w-1/3" />
    </div>
